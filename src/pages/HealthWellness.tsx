  ...
  return (
    <Section className="bg-white">
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              ...
              <tr className="bg-cream">
                ...
                <td className="border border-gray-300 px-4 py-2" colSpan={2}>Free choice access to fresh clean water (minimum 10-12 gallons per day) <sup><Link to="/citations#iowa-state-senior" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[12]</Link></sup></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="bg-white rounded-softer p-6 border border-gray-200 mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Based on the guidelines of the AAEP, Billy receives all the core vaccines annually <sup><Link to="/citations#aaep-vaccination" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[16]</Link></sup>. Billy receives some of the risk-based vaccines every 6 months based on his living situation at the Oppenheimer Family Equine Center. Every 6 months Billy received Equine Herpesvirus-1 (EHV-1), Equine Herpesvirus-4 (EHV-4), West Nile Virus, and Equine Influenza Virus (EIV) <sup><Link to="/citations#aaep-vaccination" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[16]</Link></sup>. He gets these vaccines once in the spring and fall. On an annual basis, Billy gets the Tetanus, Rabies, and Eastern/Western Encephalomyelitis vaccines in the spring <sup><Link to="/citations#aaep-vaccination" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[16]</Link></sup>.
        </p>
        ...
        <div className="bg-cream rounded-soft p-4 mb-4">
          ...
          <div className="space-y-2 text-gray-700 text-sm">
            ...
            <p>
              <span className="font-medium">West Nile Virus (Every 6 months):</span> Billy receives this vaccine because of California's mosquito populations <sup><Link to="/citations#aaep-vaccination" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[16]</Link></sup>.
            </p>
            <p>
            ...
            <p>
              <span className="font-medium">Rabies (Annual):</span> Given once a year because of California's wildlife <sup><Link to="/citations#aaep-vaccination" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[16]</Link></sup>.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-6">
          <div className="bg-cream rounded-soft p-4">
            ...
            <p className="text-gray-700 text-sm">
              Billy gets dewormed with an Ivermectin and Praziquantel combination to mitigate bots, small/large strongyles, and tapeworms <sup><Link to="/citations#smartpak-deworming" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[17]</Link></sup>.
            </p>
          </div>
          <div className="bg-cream rounded-soft p-4">
            <h3 className="font-semibold text-navy-blue mb-2">Late Spring (May/June):</h3>
            <p className="text-gray-700 text-sm">
              Billy receives Moxidectin and Praziquantel to treat smaller strongyles, large strongyles, and tapeworms during grazing season <sup><Link to="/citations#smartpak-deworming" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[17]</Link></sup>.
            </p>
          </div>
          <div className="bg-cream rounded-soft p-4">
            <h3 className="font-semibold text-navy-blue mb-2">Fecal Egg Count Testing:</h3>
            <p className="text-gray-700 text-sm">
              Billy receives a fecal egg count 1-2 times a year to determine his parasites and to see if he needs additional treatments <sup><Link to="/citations#smartpak-deworming" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[17]</Link></sup>. This approach is the most effective in seeing whether or not deworming is necessary based on his fecal egg count to avoid anthelmintic resistance <sup><Link to="/citations#smartpak-deworming" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[17]</Link></sup>.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 text-gray-700">
          ...
          <div className="bg-white rounded-soft p-4">
            ...
            <ul className="list-disc list-inside space-y-2 mt-2">
              <li>Extending isolation periods to 21 days due to most diseases showing clinical signs at the 14+ day mark <sup><Link to="/citations#aaep-biosecurity" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[19]</Link></sup></li>
              <li>Including signs for visitors about biosecurity practices <sup><Link to="/citations#aaep-biosecurity" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[19]</Link></sup></li>
              <li>Building a separate quarantine facility at the equine center to prevent any airborne transmission between quarantined horses and long-time residents <sup><Link to="/citations#aaep-biosecurity" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[19]</Link></sup></li>
              <li>Including parasite screening with incoming horses 30 days before they arrive to help determine any high shedders before being put out onto the pasture <sup><Link to="/citations#aaep-biosecurity" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[19]</Link></sup></li>
            </ul>
          </div>
        </div>
      </div>
