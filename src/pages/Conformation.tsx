        ...
        <div className="bg-white rounded-softer p-6 border border-gray-200 mb-12">
          ...
          <div className="space-y-4 text-gray-700">
            <div>
              ...
              <p>Billy demonstrates good hip length in his hindquarters, which is consistent with AQHA standards for Quarter Horse conformation <sup><Link to="/citations#aqha-balanced-horse" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[8]</Link></sup>.</p>
            </div>
            <div>
        ...
        <div className="bg-cream rounded-softer p-6">
          ...
          <div className="space-y-4 text-gray-700">
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li> Billy's 60-degree shoulder angle differs from the ideal 45-50 degrees recommended by AQHA <sup><Link to="/citations#aqha-balanced-horse" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[8]</Link></sup></li>
              <li> Billy's shorter 1:1.5 ratio translates into a back that is too long relative to his underline <sup><Link to="/citations#aqha-balanced-horse" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[8]</Link></sup></li>
              <li> Billy's neck topline and bottomline are proportional in length to each other, but they still lack the ideal ratio of a longer neck topline to shorter bottomline <sup><Link to="/citations#aqha-balanced-horse" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[8]</Link></sup></li>
              <li> Billy's shoulder:back:hip ratio of 0.8:1:1 is slightly unbalanced compared to the standard 1:1:1 <sup><Link to="/citations#aqha-balanced-horse" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[8]</Link></sup></li>
              <li> Billy's limbs are splay-footed and cow-hocked, with camped under hindlimbs that do not align with AQHA standards <sup><Link to="/citations#aqha-balanced-horse" className="text-navy-blue font-semibold underline hover:text-forest-green transition-colors">[8]</Link></sup></li>
            </ul>
