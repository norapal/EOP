  ...
  return (
    <Section className="bg-white">
      <div className="mb-8">
        ...
        Being able to analyze the quality of movement of your horse and how it relates to their conformation is essential for determining a horse's performance and overall wellbeing. Form to function demonstrates how structure impacts the quality of a horse's gait. 
        </p>
      </div>
      ...
      <div className="bg-cream rounded-softer p-6 mb-12">
        ...
        <div className="space-y-4 text-gray-700">
          <div>
            ...
            <p>Billy's steep shoulder angle of 60 degrees shortens his stride and puts a lot of stress on his forelimbs. This stress on his forelimbs was identified during his irregular gait patterns and shortened tempo across all his gaits. His 1:1.5 topline to bottomline ratio affects Billy's weight distribution and movement quality, which causes the uneven footfalls in his walk and trot. Furthermore, the splay-footed limb conformation on Billy's front limbs stresses his joints with each step. The cow-hocked and camped under conformation on his hindlimbs stresses the hock joints. This ultimately prevents Billy from fully utilizing his hindquarters to push forward movement. This was most notable in his canter and trot sequence.</p>
          </div>
          <div>
            <h3 className="font-semibold text-navy-blue mb-2">Movement Quality Assessment:</h3>
            <p>Billy's quality of movement is severely impacted across all three of his gaits. This is caused by his conformational limitations and lameness. The steep shoulder angle (60 degrees) limits Billy's ability to achieve lengthened and relaxed strides. Regardless of soundness, the lengthened and relaxed strides characterize the ideal Quarter Horse. Billy's lameness on his right side causes him to minimize weight on that side of his body. This creates irregularities in his rhythm and shortens his strides. Billy's conformational faults, like his steep shoulder, splay footed front limbs, and cow hocked and camped under limbs, create these gait irregularities that he displayed in his movement videos. These irregularities are primarily caused by his conformational faults that prevent even weight distribution and proper joint flexion. All of his gaits demonstrate a lack of harmony in his movement. Billy has very restrained movement patterns to avoid any extra pain.</p>
          </div>
        </div> 
      </div>
      ...
      <div className="bg-white rounded-softer p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-700">Billy's movement is different from that of an ideal Quarter Horse. Regardless of his lameness, his conformation structure prevents him from achieving ideal movement. Billy's gait is very irregular, which is primarily caused by both his conformational issues and lameness on his right side. His steep shoulder angle restricts his range of motion in his shoulder joint. This limits his ability to extend his stride forward. As mentioned, ideal movement should be rhythmic and even, but Billy's footfalls are uneven. He also avoids pressure on his right side, which makes his strides short and restricted. The most significant area of restraint in movement is in the canter. Billy is not able to maintain a canter and suspend. The movement lacks a relaxed and effortless movement forward. He appears very guarded and cautious in his movement due to the impact of his structural limitation and pain avoidance caused by lameness.</p>
          </div>
        </div>
