...
registered horses.
            ...
            <div className="bg-white rounded-softer p-6 border border-gray-200">
              ...
              <div className="mt-6">
                <ImageUpload
                  label="Photo documentation of behavior modification"
                  aspectRatio="aspect-[4/3]"
                />
              </div>
              <div className="mt-4">
                <label className="block text-sm font-medium text-navy-blue mb-2">
                  Video URL (YouTube or Vimeo) - Behavior modification demonstration
                </label>
                <input
                  type="text"
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <HorseImage
                src="/images/billy-front-2.jpg"
                alt="Image 3: Additional front view of Billy"
                title="Image 3: Additional front view"
                aspectRatio="aspect-[4/3]"
                onClick={() => setLightboxImage('/images/billy-front-2.jpg')}
              />
            </div>
          </div>
        </div>
